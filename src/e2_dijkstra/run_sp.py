...
def main(cfg_path):
    ...
    df = pd.DataFrame([{"variant":"V2", "nodes":G.number_of_nodes(), "edges":G.number_of_edges()}])
    df.to_csv(out_dir/"e2_dijkstra_ok.csv", index=False)
    print("E2 OK ->", out_dir/"e2_dijkstra_ok.csv")
